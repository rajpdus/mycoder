"""
Test script for the Anthropic provider.

This script tests the basic functionality of the Anthropic provider.
"""
...
async def test_anthropic_provider():
    """Test the Anthropic provider with a simple conversation."""
    # Create provider
...
async def test_anthropic_with_tools():
    """Test the Anthropic provider with tool use."""
    # Create provider
    provider = create_anthropic_provider()
